...
public class Gibs extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    EditText ishod1;
    EditText ishod2;
    EditText ishod3;
    EditText ishod4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gibs);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        Intent i = new Intent(this, search3.class);
        finish();
        startActivity(i);
        return false;
    }
