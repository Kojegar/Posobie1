...
public class Entrop extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    EditText ishod1;
    EditText ishod2;
    EditText ishod3;
    EditText ishod4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entrop);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        Intent i = new Intent(this, search2.class);
        finish();
        startActivity(i);
        return false;
    }
